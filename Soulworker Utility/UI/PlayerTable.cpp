...
VOID PlayerTable::Update() {
	...
	DAMAGEMETER.GetLock();
	{
		...
		sprintf_s(title, 128, "%s : %02d:%02d [v1.2.9.9_%s]  ###DamageMeter", DAMAGEMETER.GetWorldName(), (UINT)DAMAGEMETER.GetTime() / 60, (UINT)DAMAGEMETER.GetTime() % 60, SWPACKETMAKER.GetKeyInfo());
