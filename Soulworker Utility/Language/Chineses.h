#pragma once
//#define ERROR_MSG_WINDIVERT_241 L"驅動程式安裝失敗，點擊確認前往下載Windows更新"
...
#define STR_TABLE_DODGE_COUNT u8"閃避"
...
#define STR_UTILWINDOW_MEOW u8"圖表"

#define STR_UTILWINDOW_DPSGRAPH u8"DPS變化圖"
#define STR_UTILWINDOW_DPSGRAPH_TIME_SEC u8"Time(秒)"
#define STR_UTILWINDOW_ABGRAPH u8"貫穿變化圖"
#define STR_UTILWINDOW_ABGRAPH_TIME_SEC u8"Time(秒)"
#define STR_UTILWINDOW_JQGRAPH u8"女王層數變化圖"
#define STR_UTILWINDOW_JQGRAOH_TIME_SEC u8"Time(秒)"
#define STR_UTILWINDOW_BOSSHPGRAPH u8"Boss血量變化圖"
#define STR_UTILWINDOW_BOSSHPGRAPH_TIME_SEC u8"Time(秒)"
